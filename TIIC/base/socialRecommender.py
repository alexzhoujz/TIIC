...
class SocialRecommender(IterativeRecommender):
    def __init__(self, conf, trainingSet, testSet, relation, itemRelation, fold='[1]'):
        ...
        self.item = Item(self.config, itemRelation)  # item relations access control
        # ==================user===================
        # data clean
        cleanList = []
        cleanPair = []
    ...
    def printAlgorConfig(self):
        ...
        print('Social relation size ', '(User count:', len(self.social.user),
              'Relation count:' + str(len(self.social.relation)) + ')')
